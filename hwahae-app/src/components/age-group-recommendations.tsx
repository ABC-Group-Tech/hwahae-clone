...
export default function AgeGroupRecommendations() {
  const [activeAgeGroup, setActiveAgeGroup] = useState("20대")
  ...
  return (
    <section className="py-4 bg-white">
      <Link href="/rankings?tab=연령대별" className="px-4 mb-3 flex items-center justify-between">
        <h2 className="text-base font-bold text-[#1a1a1a]">나이대별 추천</h2>
